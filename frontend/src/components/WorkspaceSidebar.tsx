            ...
            <div className="space-y-1 mt-1">
              {selectedWorkspace.members?.map((member) => {
                ...
                return (
                  <div
                    key={member._id}
                    className="flex items-center gap-2.5 px-2 py-1.5 rounded-lg hover:bg-slate-200/40 dark:hover:bg-slate-800/30 transition text-slate-700 dark:text-slate-350 text-sm"
                  >
                    {/* Member Avatar */}
